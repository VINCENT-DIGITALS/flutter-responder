...
class IncidentReportMap extends StatefulWidget {
  final String locationName;
  final LatLng LocationCoords;
  final String incidentType;

  const IncidentReportMap({
  ...
  @override
  State<IncidentReportMap> createState() => _IncidentReportMapState();
}

class _IncidentReportMapState extends State<IncidentReportMap> {
  ...
  List<Marker> getMarkers() {
    List<Marker> markers = [
      Marker(
        ...
        key: const Key(
            'reportIncidentrMarker'), // Add unique key for popup functionality
      ),
    ];
...
// Helper function to convert LatLng to 'longitude,latitude' string format
  ...
  getCoordinates() async {
    ...
    if (_currentLocation != null) {
      ...
      String endPoint = latLngToString(widget.LocationCoords);
          ...
          FlutterMap(
            ...
            options: MapOptions(
              initialCenter: widget
                  .LocationCoords, // Center on evacuation location initially
              initialZoom: 15,
              maxZoom: 20,
              minZoom: 13,
              onTap: (_, __) =>
                ...
                options: PopupMarkerLayerOptions(
                  ...
                  popupDisplayOptions: PopupDisplayOptions(
                    builder: (BuildContext context, Marker marker) {
                      ...
                      if (marker.key == const Key('reportIncidentrMarker')) {
                        return Container(
                          color: Colors.white,
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Report: ${widget.locationName}'),
                              SizedBox(
                                  height: 8), // Add spacing between the texts
                              Text('Incident Type: ${widget.incidentType}'),
                            ],
                          ),
                        );
                      } else if (marker.key ==
              ...
              IconButton(
                ...
                onPressed: () {
                  if (widget.LocationCoords != null) {
                    mapController.move(widget.LocationCoords!, 15.0);
                  } else {
